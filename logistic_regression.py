...
#Bağımlı ve Bağımsız değişkenler arasındaki ilişkiyi doğrusal olarak modellemek
...
df = pd.read_csv("C:/Users/izzet/PycharmProjects/pythonProject/machine_learning/datasets/diabetes.csv")
